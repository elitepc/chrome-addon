  ...
  try {
    ...
    return {
      ...
      salaryCompanyDetails: {
        salaryMin: res.data.salary_company_details.salary_min,
        salaryMax: res.data.salary_company_details.salary_max,
        salaryMedian: res.data.salary_company_details.salary_median,
        totalSalaries: res.data.salary_company_details.total_salaries,
      },
